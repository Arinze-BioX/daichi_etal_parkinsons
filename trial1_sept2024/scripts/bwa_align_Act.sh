...
bwa mem grna_daichi_sept2024.fa ${PATH1}${sample}_uminamed_R1_001.fastq.gz ${PATH1}${sample}_uminamed_R2_001.fastq.gz > /datacommons/ydiaolab/arinze/daichi/trial1_sept2024/sam/${sample}_bwa_Act_long.sam
