...
PATH1='/datacommons/ydiaolab/arinze/daichi/trial2_Oct2024/selected_InPlasmid_reads/'
samples=($(ls ${PATH1}*_post_R1_001.fastq.gz | perl -p -e "s/\/.*selected_InPlasmid_reads\///g" | perl -p -e "s/_R1_001\.fastq\.gz//g"))
